...
a = readRDS(file='marinecoldWave_post_processing.rds')
...
ggplot()+
  ...
  facet_wrap(~mn)+
  theme_test_adam()+
  labs(title='Climatology - Lower Threshold')+
  coord_sf(xlim=c(bb[1],bb[3]),ylim=c(bb[2],bb[4]))
...
afl = readRDS('ClimatologyMHWThresolds.rds')
